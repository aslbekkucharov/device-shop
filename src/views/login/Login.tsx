        ...
        <div className={classes['login-page']}>
            <div className={classes['login-form']}>
                ...
                <Form
                    ...
                    render={(props: FormRenderProps<LoginPayload>) => <LoginForm {...props} />}
                />

                <div className={classes['login-form__footer']}>
                    <Button onClick={handleAutoFill} type='text' size='small' icon={<CheckCircleOutlined />} iconPosition='end'>Заполнить автоматически</Button>
                </div>
            </div>
        </div>
    )
